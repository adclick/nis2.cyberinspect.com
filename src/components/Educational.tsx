        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-foreground">
              A NIS2 não é opcional. <span className="bg-gradient-cyber bg-clip-text text-transparent">É obrigatória.</span>
            </h2>
          ...
          <div className="mt-12 p-8 bg-gradient-to-r from-cyberBlue/10 to-primary/10 rounded-2xl border border-cyberBlue/20 shadow-card">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3">A <span className="font-bold bg-gradient-cta bg-clip-text text-transparent">responsabilidade é da gestão de topo</span></h3>
